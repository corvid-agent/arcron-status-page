...
At TestNet last-round **67213546** (probed 2026-09-11T22:11:58.826Z UTC / 2026-09-11 16:11 America/Denver), unsigned `execute` simulate (allow-empty-signatures) against app `769891898` split overdue upkeeps as:

- **unfunded** 13 — ids 98–109, 120 (escrow cannot pay effective fee; balance < fee; simulate quote `logic eval error: assert failed pc=1181`)
- **reverting** 0
- **waiting** 0
...
- **on schedule** 20 — ids 19, 20, 21, 22, 82, 84, 85, 86, 89, 92, 93, 94, 110, 111, 112, 113, 114, 115, 117, 119
