...
At TestNet last-round **66864878** (probed 2026-09-01T01:05:04.915Z UTC), unsigned `execute` simulate (allow-empty-signatures) against app `769891898` split overdue upkeeps as:

- **unfunded** 12 — ids 98–109 (escrow cannot pay effective fee; balance < fee; simulate quote `logic eval error: assert failed pc=1181`)
- **reverting** 0
- **waiting** 0
- **other** 0
- **on schedule** 20 — ids 19–22, 82, 84–86, 89, 91–94, 110–116
